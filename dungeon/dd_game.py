...
def get_locations(cells):
    """Randomly pick starting locations for the monster, door, and player.
    ...
    # Great example of a recursive function here.
...
def move_player(player, move):
    """Based on tuple of player's position, return new position after move.

    >>> player = {'location': (1, 1), 'path': []}
